#!/bin/bash
# =============================================================================
# Build a LLM from scratch - Configuration de l'environnement de développement
# =============================================================================
set -e

PYTHON_VERSION="3.12"

echo "🚀 Configuration de l'environnement Build a LLM from scratch"
echo "=================================================================="
...
setup_github() {
    ...
    if [ "castorfou" != "votre-username" ]; then
        ...
        if ssh -o BatchMode=yes -T git@github.com 2>&1 | grep -iq "successfully authenticated"; then
            remote_url="git@github.com:castorfou/build-a-llm-from-scratch.git"
        else
            remote_url="https://github.com/castorfou/build-a-llm-from-scratch.git"
        fi
